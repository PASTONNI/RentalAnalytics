...
Calculated average days between rentals per customer using window functions (LAG() / LEAD()) to measure engagement frequency.
...
Using the dataset’s timeline (MAX(rental_date) + 2 days)

Scheduled to refresh automatically at 5:00 AM
